...
///@arg y
///@arg creator
	// hurtbox can be used with any object, meaning they can collide with other hitboxes
	// hurtbox needs to know who created it so it doesn't deal damage to whoever created it
///@arg sprite
///@arg knockback
///@arg lifespan
///@arg damage
...
// also want hitbox to face same direction of the player
